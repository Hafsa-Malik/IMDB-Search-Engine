...
public:
    ...
    //---------------Task4--------------------------------
    void searchCoActorOfCoActors(string name)
    {
        if (start != NULL)
        {
            MovieNode *temp = start;
    ...
    void printActorCoactors(string Actorname)
    {
        ...
        else
        {
            map<string, MovieList>::iterator actoritr;
            actoritr = actorListHashmap.find(Actorname);
            cout << "bool is not" << endl;
            actoritr->second.SearchCoActor(Actorname);
        }
    }

    void printCoactorsOfCoactors(string Actorname)
    {
        if (actorListHashmap.count(Actorname) == 0)
            cout << "Actor Not Found" << endl;
        else
        {
            map<string, MovieList>::iterator actoritr;
            actoritr = actorListHashmap.find(Actorname);
            actoritr->second.searchCoActorOfCoActors(Actorname);
        }
    }
...
int main()
{
    ...
    const char *p1 = "E:\\OneDrive - National University of Sciences & Technology\\1. Uni Semester\\3rd Semester\\Data Structures & Algorithms\\Project\\DSA-Mini-Project\\DSA-Mini-Project\\DSA-mini-Project\\test.txt";
    char *p2;
    ...
    M.printCoactorsOfCoactors("CCH Pounder");
    cout << endl;
